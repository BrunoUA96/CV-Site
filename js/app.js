...
addEventListener('DOMContentLoaded', () => {
    ...
    // Age Counter
    let today = new Date();
    let birthDate = new Date('1996/07/16');
    document.querySelector('.img_box_prifile--contacts__count').innerText = today.getFullYear() - birthDate.getFullYear();

    // All Tabs Buttons and Tabs Content
    const tabsNav = document.querySelectorAll('.tabs_nav_item'),
        tabsContent = document.querySelectorAll('.tab_content'), rightSideSite = document.querySelector('.right_side'),
...
const mobileAddTabImage = () => {
    ...
    mobileTabImg.innerHTML = '<i class="fa fa-picture-o" aria-hidden="true"></i><span class="tabs_nav_item-text"> Info </span>';
